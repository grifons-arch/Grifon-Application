...
import com.example.grifon.di.AppModule;
...
public final class GrifonApplication_HiltComponents {
  private GrifonApplication_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements GrifonApplication_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          PdpViewModel_HiltModules.KeyModule.class,
          PlpViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          ...
          PdpViewModel_HiltModules.BindsModule.class,
          PlpViewModel_HiltModules.BindsModule.class,
